...
class Ellipse extends Elements {
    name = {
        name: "ellipse" + nameId$g.toString(),
        graphicId: nameId$g
    };
    constructor(opts) {
        super();
...
class Polygon extends Elements {
    name = {
        name: "polygon" + nameId$f.toString(),
        graphicId: nameId$f
    };
    constructor(opts) {
        super();
...
function handleError$1(f, args) {
    try {
        ...
        wasm$2.__wbindgen_exn_store(addHeapObject$1(e));
    }
}
...
function getUint8Memory0$1() {
    if (cachedUint8Memory0$1 === null || cachedUint8Memory0$1.byteLength === 0) {
        cachedUint8Memory0$1 = new Uint8Array(wasm$2.memory.buffer);
    }
...
function getUint16Memory0$1() {
    if (cachedUint16Memory0$1 === null || cachedUint16Memory0$1.byteLength === 0) {
        cachedUint16Memory0$1 = new Uint16Array(wasm$2.memory.buffer);
    }
...
function pre_singrat$2(radius, pixels_per_degree, spatial_frequency, angle, contrast, phase, gamma) {
    try {
        const retptr = wasm$2.__wbindgen_add_to_stack_pointer(-16);
        wasm$2.pre_singrat(retptr, radius, pixels_per_degree, spatial_frequency, angle, contrast, phase, gamma);
        var r0 = getInt32Memory0$1()[retptr / 4 + 0];
        var r1 = getInt32Memory0$1()[retptr / 4 + 1];
        var v1 = getArrayU16FromWasm0$1(r0, r1).slice();
        wasm$2.__wbindgen_free(r0, r1 * 2, 2);
        return v1;
    }
    finally {
...
function pre_noise_singrat$2(radius, pixels_per_degree, spatial_frequency, angle, contrast, phase, level, gamma) {
    try {
        const retptr = wasm$2.__wbindgen_add_to_stack_pointer(-16);
        wasm$2.pre_noise_singrat(retptr, radius, pixels_per_degree, spatial_frequency, angle, contrast, phase, level, gamma);
        var r0 = getInt32Memory0$1()[retptr / 4 + 0];
        var r1 = getInt32Memory0$1()[retptr / 4 + 1];
...
class sinGrating extends Elements {
    name = {
        name: "singrating" + nameId$b.toString(),
        graphicId: nameId$b
    };
    param;
    width;
    ...
    async pre_draw() {
        ...
        if (!timeFrequency) {
            if (this.isNoise) {
                param = pre_noise_singrat$2(sh.r, sh.pixelsPerDegree, sh.spatialFrequency, sh.angle, sh.contrast, sh.phase, sh.level, sh.gamma);
            }
            else
                param = pre_singrat$2(sh.r, sh.pixelsPerDegree, sh.spatialFrequency, sh.angle, sh.contrast, sh.phase, sh.gamma);
            ...
            if (this.isNoise) {
                await Promise.all(array.map(async (item, index) => {
                    let param = pre_noise_singrat$2(sh.r, sh.pixelsPerDegree, sh.spatialFrequency, sh.angle, sh.contrast, sh.phase + index * interval, sh.level, sh.gamma);
                    const img = new Array();
                    for (let i = 0, j = 0; i < this.sinGrat.data.length; i += 4, j++) {
                        img[i + 0] = param[j];
                        img[i + 1] = param[j];
                ...
                await Promise.all(array.map(async (item, index) => {
                    await getWasm();
                    let param = pre_singrat$2(sh.r, sh.pixelsPerDegree, sh.spatialFrequency, sh.angle, sh.contrast, sh.phase + index * interval, sh.gamma);
                    const img = new Array();
                    for (let i = 0, j = 0; i < this.sinGrat.data.length; i += 4, j++) {
                        img[i + 0] = param[j];
                        img[i + 1] = param[j];
...
function sample(imports){return _loadWasmModule(0, null, '', imports)}
...
const encodeString = ("encodeInto" in cachedTextEncoder && typeof cachedTextEncoder.encodeInto === 'function'
    ?
        function (arg, view) {
...
* @param {number} gamma
*/
function pre_singrat(id, x, y, radius, pixels_per_degree, spatial_frequency, angle, contrast, phase, gamma) {
    try {
...
function pre_noise_singrat(r, pixelsPerDegree, spatialFrequency, angle, contrast, phase, level, gamma) {
...
async function setWasm() {
    const instance = sample({
        wbg: {
            ...
            __wbg_getContext_69ec873410cbba3c: function () {
            ...
            __wbg_newwithu8clampedarrayandsh_aa7545d0ba5b755e: function () {
                return handleError(function (arg0, arg1, arg2, arg3) {
                    const ret = new ImageData(getClampedArrayU8FromWasm0(arg0, arg1), arg2 >>> 0, arg3 >>> 0);
                    return addHeapObject(ret);
                }, arguments);
            },
            __wbg_putImageData_d8c261486f99879a: function () {
                return handleError(function (arg0, arg1, arg2, arg3) {
            ...
            __wbg_call_1084a111329e68ce: function () {
            ...
            __wbg_call_89af060b4e1523f2: function () {
                return handleError(function (arg0, arg1, arg2) {
...
let nameId$9 = 0;
class sinGrating2 extends Elements {
    name = {
    ...
    async pre_draw() {
        ...
        if (!timeFrequency) {
            if (this.isNoise) {
                pre_noise_singrat(sh.r, sh.pixelsPerDegree, sh.spatialFrequency, sh.angle, sh.contrast, sh.phase, sh.level, sh.gamma);
            }
            else
                pre_singrat(this.ctx.canvas.id, sh.x - 1.5 * sh.r, sh.y - 1.5 * sh.r, sh.r, sh.pixelsPerDegree, sh.spatialFrequency, sh.angle, sh.contrast, sh.phase, sh.gamma);
            // for (let i = 0, j = 0; i < this.sinGrat.data.length; i += 4, j++) {
            //     const rgb = searchMap124(noiseBit(param[j]))
            //     this.sinGrat.data[i + 0] = rgb.r;
            //     this.sinGrat.data[i + 1] = rgb.g;
            //     this.sinGrat.data[i + 2] = rgb.b;
            //     this.sinGrat.data[i + 3] = 255;
