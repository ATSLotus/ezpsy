var ezpsy = (function () {
    ...
    class Ellipse extends Elements {
        name = {
            name: "ellipse" + nameId$c.toString(),
            graphicId: nameId$c
        };
        constructor(opts) {
            super();
    ...
    class Polygon extends Elements {
        name = {
            name: "polygon" + nameId$b.toString(),
            graphicId: nameId$b
        };
        constructor(opts) {
            super();
